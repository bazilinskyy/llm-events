...
if __name__ == '__main__':
    ...
    if SHOW_OUTPUT:
        ...
        analysis.hist(df, x=['q5_collision_type'],
                      yaxis_title='Q5. Accident damage and consequences(What): Collision type',
                      marginal=None,
                      pretty_text=True,
                      save_file=True,
                      open_browser=True)
        analysis.hist(df, x=['q5_av_damage'],
                      ...
                      save_file=True,
                      open_browser=True)
        analysis.hist(df, x=['q5_av_damage_category'],
                      yaxis_title='Q5. Accident damage and consequences(What): AV damage category',
                      marginal=None,
                      pretty_text=True,
                      save_file=True,
                      open_browser=True)
        analysis.hist(df, x=['q5_other_vehicle_damage'],
                      yaxis_title='Q5. Accident damage and consequences(What): Other vehicle damage',
                      marginal=None,
                      pretty_text=True,
                      save_file=True,
                      open_browser=True)
